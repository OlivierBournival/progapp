...
public class UserServiceImpl implements UserService {
    ...
    public int updateUser(Long userId, String publicUsername) {
        // TODO Mon collègue m'a dit qu'il y a un problème avec les injections SQL mais je vois pas trop où est le problème..."UPDATE MUSER SET PUBLIC_NAME = '" + publicUsername + "' WHERE ID = " + userId + ""
        return jdbcTemplate.update(
                "UPDATE MUSER SET PUBLIC_NAME = '?' WHERE ID = ?", publicUsername , userId
        );
    }
